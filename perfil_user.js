$(document).ready(function() {
    ...
    var url1 = "https://andresfdtc.github.io/HomeElectric/home_electric_project/perfil/info_user/" + user_id
    fetch(url1)
    ...
    var url2 = `https://andresfdtc.github.io/HomeElectric/home_electric_project/alquiler/rents_user/${user_id}`
    fetch(url2)
        .then(response => response.json()) 
        .then(json => {
            console.log(json)
